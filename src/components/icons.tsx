...
export function SidebarIcon({ size = 15, className }: IconProps) {
  return (
...
export function FolderIcon({ size = 14, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="rgba(0,0,0,0.08)"
...
export function NoteIcon({ size = 14, strokeWidth = 1.6, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
...
export function StarIcon({ size = 11, filled = false, className }: IconProps & { filled?: boolean }) {
  return (
...
export function ChevronRightIcon({ size = 11, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
      style={{ opacity: 0.3, flexShrink: 0 }} className={className}>
